...
do
  ...
  do
    ...
    do
        ...
        echo "python drqbc/main.py  task_name=offline_${env}_${typ} offline_dir=/my/offline/dataset/dir/offline_data/main/${env}/${typ}/84px algo=drqbcbpr nstep=3 seed=${seed}">> temprun.sh
